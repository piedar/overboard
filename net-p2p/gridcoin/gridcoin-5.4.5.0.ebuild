...
SRC_URI+=" ${GH_REPO}/commit/5e1ed2f46f7fa7479c366b853442d9dacdbcceb5.patch -> ${PN}-allow-system-bdb.patch" # todo: remove in future version
...
PATCHES=(
  "${DISTDIR}/${PN}-allow-system-bdb.patch"
)
